...
${Purple}|${Font_default}${Red}Öndüriji:${Yellow} cracker       ${Purple}            ${Font_default}${Purple}|${Font_default}
${Purple}|${Font_default}${Red}TELEGRAM:${Yellow} @crackervpn           ${Purple}            ${Font_default}${Purple}|${Font_default}
